...
return (
  <main className="min-h-screen w-full max-w-screen-2xl mx-auto bg-gradient-to-br from-[#f9f5f0] to-[#e6dfd7] dark:from-gray-900 dark:to-gray-800">
    <link
